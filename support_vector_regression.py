...
def svm(training_data: str, test_set: str) -> None:
    ...
    x_train, x_test, y_train, y_test = train_test_split(dataset, dataset['home_team_result'], test_size=0.999)
    '''
    x_train = dataset
...
if __name__ == '__main__':
    svm('reconstructed_match_history.csv', 'dataset/test_set.csv')